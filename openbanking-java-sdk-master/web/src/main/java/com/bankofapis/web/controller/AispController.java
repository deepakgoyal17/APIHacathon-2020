...
public class AispController {
    ...
    @GetMapping(value = ACCOUNT_ID_VIRTUALACC_ENDPOINT)
    public OBReadDataResponse<OBReadVirtualAccounts> getVirtualAccounts(
        @PathVariable(value = "accountId") String accountId) {
        return aispService.getVirtualAccounts(accountId);
    }
}