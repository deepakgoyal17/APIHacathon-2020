Goal
---
The aim of the SDK is to demonstrate How the Money Matters Product Works. The SDK uses the base SDK provided by the Apithon Team.

The sample data used to this demo is kept in sample_data.yml. which should be uploaded to the Test Data in the developer UI.
